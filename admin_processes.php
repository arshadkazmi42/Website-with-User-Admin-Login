...
*/
	...
	function Voilation($post, $process) {
		...
		$target			= "www.kaspattest.bugs3.com/final/images";
		...
		$moved = move_uploaded_file($_FILES['photo']['tmp_name'], "images/".$pic);
		if ($moved) {
				echo "<p>moved!";
				}
			else {
   ...
   $this->create_table($result, $num_rows);
	...
	function create_table($result, $num_rows) {
	   ...
	   echo "<tr class=\"tabel_header\">
			 ...
			 <th align=\"center\" width=\"15%\"><strong> Phone Number:</strong></th>
	  		 <th align=\"center\" width=\"15%\"><strong> License Plate No:</strong></th>
